...
8. [Hướng Dẫn Dành Cho Frontend (Mock UI Guide)](#8-hướng-dẫn-dành-cho-frontend-mock-ui-guide)
...
## 8. HƯỚNG DẪN DÀNH CHO FRONTEND (MOCK UI GUIDE)

### 8.1. Cách gắn Access Token
...
### 8.4. Xử lý vòng đời Token (Token Lifecycle — RC-15)
...
### 8.5. Xử lý lỗi validation per-field (Multi-field errors)
...
### 8.6. Bảng tổng hợp Token Configuration (cho FE lưu trữ)
