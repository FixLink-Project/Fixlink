...
public class RegisterTechnicianRequest {
    ...
    @Pattern(
        regexp = "^(?=.*[A-Z])(?=.*[!@#$%^&*()_+\\-=\\[\\]{};':\"\\\\|,.<>\\/?]).{8,}$",
        message = "Mật khẩu phải có tối thiểu 8 ký tự, bao gồm ít nhất 1 chữ cái viết hoa và 1 ký tự đặc biệt"
    )
    ...
    @Size(min = 9, max = 12, message = "Số CCCD phải có từ 9 đến 12 chữ số")
